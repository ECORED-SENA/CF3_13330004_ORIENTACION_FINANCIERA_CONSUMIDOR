  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5(data-aos="fade")
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Reconocer las técnicas y estrategias que abarcan la negociación empresarial.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Verdadero/Falso
            .col-auto
              a.boton.boton--b(:href="obtenerLink('/actividades/ActividadDidactica/story.html')" target="_blank")
                span Realizar
